...
| Game phases | [`Phases/Phases Overview.md`](Phases/Phases%20Overview.md) | `core/phases.ttslua`, `core/session_explode.ttslua`, `lib/constants.ttslua` (`C.Phases`), `ui/storyteller/panel_phases.xml`, `ui/shared/panel_overlay_global_blindfold.xml` |

...
| Linear sync / issue-limit purge | [`../.cursor/rules/toronto-rising-linear.mdc`](../.cursor/rules/toronto-rising-linear.mdc), [`DEVELOPMENT_WORKFLOW.md`](DEVELOPMENT_WORKFLOW.md) § Linear | Delete **Done + author-confirmed** only when the issue limit blocks creates; log in [`plans/linear-alignment-log.md`](plans/linear-alignment-log.md) |

...
|---|---|---|
| Synchronization/reconcilers | [`Sychronizing Game Functionality/Reconciler Contract.md`](Sychronizing%20Game%20Functionality/Reconciler%20Contract.md), [`../.cursor/rules/toronto-rising-synchronization.mdc`](../.cursor/rules/toronto-rising-synchronization.mdc) | `core/sync.ttslua`, `core/state.ttslua`, domain reconcilers |

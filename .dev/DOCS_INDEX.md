...
| Storyteller dashboard | [`storyteller-dashboard/README.md`](storyteller-dashboard/README.md), [`Storyteller Dashboard Docs/Generic NPCs.md`](Storyteller%20Dashboard%20Docs/Generic%20NPCs.md), [`Storyteller Dashboard Docs/Scene Import Guide.md`](Storyteller%20Dashboard%20Docs/Scene%20Import%20Guide.md) | Second-monitor tabbed dashboard (Stage NPCs / Scenes / Lua / Generate NPC). Generic NPC rows refresh from **Generics Export** on dashboard server startup (`generic-npcs:import` remains available for a manual refresh). Scenes tab catalogs: `npm run dashboard:scene-catalogs`. Scene Import Guide is the live Scene Constructor JSON contract (TOR-569 / TOR-570). |

...
| Author TTS verification debt (shipped but untested) | [`PENDING AUTHOR VERIFICATION.md`](PENDING%20AUTHOR%20VERIFICATION.md) (checklist — **add a row in the same session as the ship**; process marks on `/tr-inbox`), [`PENDING AUTHOR VERIFICATION.agent.md`](PENDING%20AUTHOR%20VERIFICATION.agent.md) (agent policy) | Linear **Awaiting Author Review** comments (how-to-verify), tasklist domain bullets |
...
| Linear completion status / issue-cap recovery | [`../.cursor/rules/toronto-rising-linear.mdc`](../.cursor/rules/toronto-rising-linear.mdc), [`DEVELOPMENT_WORKFLOW.md`](DEVELOPMENT_WORKFLOW.md) § Linear | Ship to **Awaiting Author Review**; after PAV **✅**, use **Fully Complete** by default or **Complete (KEEP)** sparingly; at cap, ask the author to clear all **Fully Complete** issues |
...
| Writing TEST BED Execute Code Lua | [`../.cursor/skills/testbed/SKILL.md`](../.cursor/skills/testbed/SKILL.md) | [`.dev/testbed/TEST BED.ttslua`](testbed/TEST%20BED.ttslua) (gitignored), `core/debug.ttslua` |
...
| Hiding or revealing world objects | [`../docs/solutions/lua-hide-restore-policy.md`](../docs/solutions/lua-hide-restore-policy.md) | `core/objects.ttslua`, `GlobalHideObject` / `GlobalRestoreObject` |

## Core Architecture

| System | Read first | Source-of-truth code/data |
|---|---|---|
| Synchronization/reconcilers | [`Sychronizing Game Functionality/Reconciler Contract.md`](Sychronizing%20Game%20Functionality/Reconciler%20Contract.md), [`Sychronizing Game Functionality/Performance Audit.md`](Sychronizing%20Game%20Functionality/Performance%20Audit.md), [`Sychronizing Game Functionality/TTS-API-Heavy-Workload-Catalog.md`](Sychronizing%20Game%20Functionality/TTS-API-Heavy-Workload-Catalog.md), [`Sychronizing Game Functionality/TTS-API-Heavy-Workload-Usage-Inventory.md`](Sychronizing%20Game%20Functionality/TTS-API-Heavy-Workload-Usage-Inventory.md), [`../.cursor/rules/toronto-rising-synchronization.mdc`](../.cursor/rules/toronto-rising-synchronization.mdc) | `core/sync.ttslua`, `core/state.ttslua`, domain reconcilers |
| Multiplayer authority | [`Multiplayer Functionality/Preparing For Multiplayer.md`](Multiplayer%20Functionality/Preparing%20For%20Multiplayer.md), [`E2E Playbooks/Multiplayer-Session.md`](E2E%20Playbooks/Multiplayer-Session.md) (author session), [`E2E Playbooks/Multiplayer-E2E.md`](E2E%20Playbooks/Multiplayer-E2E.md) (agent checklist), [`Multiplayer Functionality/Join-Load Inventory.md`](Multiplayer%20Functionality/Join-Load%20Inventory.md) (engine vs Host Lua join cost), [`Multiplayer Functionality/Multiplayer-Session-Investigation-2026-07-12.md`](Multiplayer%20Functionality/Multiplayer-Session-Investigation-2026-07-12.md) (join timeouts + Hunger 5 pulse), [`../.cursor/rules/toronto-rising-multiplayer-authority.mdc`](../.cursor/rules/toronto-rising-multiplayer-authority.mdc), [`Sychronizing Game Functionality/Event Listener Policy.md`](Sychronizing%20Game%20Functionality/Event%20Listener%20Policy.md) | `core/global_script.ttslua`, `core/main.ttslua` (seat assign), `core/phases.ttslua`, event handlers, object scripts |
| Game phases | [`Phases/Phases Overview.md`](Phases/Phases%20Overview.md), Memoriam runtime: [`Phases/Memoriam.md`](Phases/Memoriam.md) | `core/phases.ttslua`, `core/session_explode.ttslua`, `core/memoriam.ttslua`, `core/memoriam_modal.ttslua`, `lib/constants.ttslua` (`C.Phases`, `C.MemoriamSkyboxes`), `ui/storyteller/panel_phases.xml`, `ui/storyteller/memoriam_modal.xml`, `ui/shared/panel_overlay_session_start.xml`, `ui/shared/panel_overlay_global_blindfold.xml` |
...
| Hide / restore objects (`y = -200`) | [`../docs/solutions/lua-hide-restore-policy.md`](../docs/solutions/lua-hide-restore-policy.md), [`../.cursor/rules/toronto-rising-hide-restore.mdc`](../.cursor/rules/toronto-rising-hide-restore.mdc) | `core/objects.ttslua`, any hide/stash/park call site |
...
| Player HUD/overlays | [`HUDs & Overlays/Player HUD Overview.md`](HUDs%20%26%20Overlays/Player%20HUD%20Overview.md), [`HUDs & Overlays/Global-UI-Image-Stacks.md`](HUDs%20%26%20Overlays/Global-UI-Image-Stacks.md) (remount weight: stacks / chrome tint / shared visibility), [`HUD_FUNCTIONS.md`](HUD_FUNCTIONS.md) | `core/hud_player.ttslua`, `core/hud_overlays.ttslua`, `ui/player/`, `ui/storyteller/`, `lib/util.ttslua` (audience visibility) |
| NPC spawning/spotlighting | [`NPC Object Spawning & Spotlighting/NPC Object Overview.md`](NPC%20Object%20Spawning%20%26%20Spotlighting/NPC%20Object%20Overview.md), [`NPC Object Spawning & Spotlighting/NPC Reconciler Procedure.md`](NPC%20Object%20Spawning%20%26%20Spotlighting/NPC%20Reconciler%20Procedure.md), [`NPC Object Spawning & Spotlighting/Storyteller Gameboard Control.md`](NPC%20Object%20Spawning%20%26%20Spotlighting/Storyteller%20Gameboard%20Control.md), Generic NPC spawn/import: [`NPC Object Spawning & Spotlighting/Generic NPCs.md`](NPC%20Object%20Spawning%20%26%20Spotlighting/Generic%20NPCs.md) | `core/npcs.ttslua`, `core/generic_npcs.ttslua`, `core/npc_gameboard.ttslua` (+ siblings `npc_gameboard_{board,tokens,snaps,reconcile,apply,interactions,spotlight}`), `lib/npcs_data.ttslua`, `lib/generic_npcs_catalog.ttslua` |
| Lighting/table layout | [`Rotational Coordinate Generator.md`](Rotational%20Coordinate%20Generator.md), [`Revision of Player Positioning/Revision of Player Positioning Proposal.md`](Revision%20of%20Player%20Positioning/Revision%20of%20Player%20Positioning%20Proposal.md), [`NPC Object Spawning & Spotlighting/NPC Light Object Data.jsonc`](NPC%20Object%20Spawning%20%26%20Spotlighting/NPC%20Light%20Object%20Data.jsonc) | `core/lighting.ttslua`, `lib/figurine_seat_layout.ttslua`, `lib/figurine_frame.ttslua`, `lib/rotational-seat-layout.ttslua`, `lib/constants.ttslua`, `lib/seat_role_offsets.ttslua` |
...
| Scenes/scene constructor | **Import JSON schema:** [`Storyteller Dashboard Docs/Scene Import Guide.md`](Storyteller%20Dashboard%20Docs/Scene%20Import%20Guide.md) (live importer; TOR-569). Library/Apply/fork: [`Scene Constructor/Scene Constructor Overview.md`](Scene%20Constructor/Scene%20Constructor%20Overview.md). JSONC templates in `Scene Constructor/` are **not** occupancy-complete. | `core/scenes.ttslua`, `core/scene_library.ttslua`, `core/storyteller_scenes_panel.ttslua`, `lib/figurine_seat_layout.ttslua` (`checkOccupancy`), `lib/skyboxes_catalog.ttslua` (from Sheet via `npm run skyboxes:import` — `SKYBOXCSV`, `SKYBOXGENERICCSV`, `SKYBOXMEMORIAMCSV`; see `docs/superpowers/specs/2026-07-21-skybox-sheet-import-design.md`). Memoriam chronology: `C.MemoriamSkyboxKeysByCharacter` / `C.getMemoriamSkyboxesForCharacter` in `lib/constants.ttslua`. Memoriam panel art: Steam Cloud `Memoriam` folder → `Cloud.MemoriamPanels` (`npm run cloud-asset-sync:catalog`) → `panelA–D.url` at Constants load; `C.resolveMemoriamPanelURL`. |
...
| Storyteller dashboard | [`storyteller-dashboard/README.md`](storyteller-dashboard/README.md), [`storyteller-dashboard/PLAYWRIGHT.md`](storyteller-dashboard/PLAYWRIGHT.md) (dedicated Playwright Chrome, no extension banner), [`storyteller-dashboard/TESTING.md`](storyteller-dashboard/TESTING.md), [`Storyteller Dashboard Docs/Generic NPCs.md`](Storyteller%20Dashboard%20Docs/Generic%20NPCs.md), [`Storyteller Dashboard Docs/Scene Import Guide.md`](Storyteller%20Dashboard%20Docs/Scene%20Import%20Guide.md), [`../dashboard/README.md`](../dashboard/README.md) (TTS Lua bridge under `dashboard/`), [`../.cursor/rules/toronto-rising-dashboard.mdc`](../.cursor/rules/toronto-rising-dashboard.mdc) | Second-monitor **Storyteller-only** web app (never a player HUD). Same git/GitHub repo as TTS Lua; dashboard-only tracking is [`storyteller-dashboard/agent/Running Tasklist.md`](storyteller-dashboard/agent/Running%20Tasklist.md). Stack: Vite + React + Node on port 8788. Generic NPC rows refresh from **Generics Export** on dashboard server startup. Scenes catalogs: `npm run dashboard:scene-catalogs` (also dashboard `dev`/`build`); polar stagger reads STAGE_BOARD from the live TTS save. Scene Import Guide is the live import JSON contract. Playwright must use the dedicated TorontoRising Chrome with the automation infobar off, not `--extension` into Cursor Chrome (that debugger bar shrinks the layout). |

...
| **Per-player transition blindfolds** | `ui/.templates/panel_overlay_blindfold.xml` → `hudBlindfold` via `core/hud_blindfold.ttslua` (optional destination District/Site card Images, TOR-425) | **No** — scene/table transitions only |

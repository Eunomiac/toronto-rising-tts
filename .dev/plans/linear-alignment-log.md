...
| 2026-09-23 | SHIP | TOR-604 | Overlay chrome via absolute UI.setClass (PLAY/MAIN = XML baseline; Downtime/prologue/Spotlight APPLY); text via setAttributes only; rename sesionNumber→sessionNumber. Pending Save & Play. |

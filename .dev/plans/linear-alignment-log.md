...
| 2026-08-22 | PAVE+FOCUS | `/tr-inbox` evening | Capture empty. Author ✅ TOR-497 / TOR-501 / TOR-500 / TOR-499 / TOR-494 / TOR-496. PAVE added TOR-498 / TOR-502 / TOR-503 / TOR-504. Focus → TOR-81, TOR-98, TOR-168. TOR-439 remains multiclient gate. |
...
| 2026-08-30 | CREATE+SHIP | TOR-535 | Play-enter OutdoorDim behind cover before explode/sting; sting delay 0.25s. relatedTo TOR-534 / TOR-533 / TOR-504. Pending Save & Play. |

| 2026-08-30 | CREATE+SHIP | TOR-538 | Overlay camera: left-click default+picker; right-click FirstPerson at default eye looking at lead figurine face; cycle occupied polar areas; Apply resets. relatedTo TOR-521. Pending Save & Play. |
| 2026-08-30 | `/tr-inbox` | PAVE | ✅ cleared TOR-247, TOR-531–TOR-536, TOR-519–TOR-523, TOR-525. ❌ TOR-518 follow-up shipped (tighter PCs panel heights). ⚠️ TOR-528 print-to-file removed. |
| 2026-08-30 | CREATE+SHIP | TOR-537 | Randomize Table B seating on cover transition; pack 1..N; control-board tokens follow; Absent stay hidden. relatedTo TOR-507 / TOR-247 / TOR-334. Pending Save & Play. |
...
| 2026-09-01 | CREATE+SHIP | TOR-545 | Memoriam bar four greys: base pair + overlay pair, alternate within each set. relatedTo TOR-544. Pending Save & Play. |
...
| 2026-09-06 | CREATE+SHIP | TOR-559 | Phases Lerp explode toggle; default TTS-attribute session-start path; relatedTo TOR-531 / TOR-516 / TOR-497. Pending Save & Play. |
...
| 2026-09-15 | CREATE+SHIP | TOR-573 | Scatter import from table=Scatter + live Standard↔Scatter translation. relatedTo TOR-572 / TOR-570 / TOR-507. Pending Save & Play. |
| 2026-09-15 | CREATE+SHIP | TOR-574 | Cloud asset sync skips missing folders (empty LuaCatalog tables / empty URLs). Memoriam NPC keys keep `mem_`. relatedTo TOR-564. Pending Save & Play. |
| 2026-09-15 | CREATE+SHIP | TOR-575 | Memoriam figurine shared back from `mem_BACK.webp` (`figurine.back`); reserved stem is not an NPC. relatedTo TOR-574. Pending Save & Play. |
...
| 2026-09-21 | SHIP | TOR-605 | Camera look-at Y is authored only (XZ follows the seat). Scatter was applying figurine FLOOR_Y delta (~9.2) to every camera. Linear quota blocked a new id. Pending Save & Play. |
...
| 2026-09-23 | SHIP | TOR-604 | Play overlay restore after prologue: match XML large_red_text (fontSize 42 / min+preferred 42) and flexibleHeight 1; drop invented 52/60 box that lifted the stack. Linear quota blocked a new id. Pending Save & Play. |
...
| 2026-09-23 | INBOX | — | Capture empty. PAVE ✅ cleared TOR-593, TOR-596, TOR-581, TOR-527, TOR-598, TOR-600, TOR-601, Play→Spotlight stage clear, TOR-605, TOR-603, TOR-597, TOR-594, TOR-143 End→Intermission, TOR-31 Willpower reroll. |

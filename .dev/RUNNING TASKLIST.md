...
_Stack rank for the current cycle (2026-08-03 — **TOR-448**/ **TOR-449** shipped). **Precedence** = Focus stack + Linear **`blockedBy`** (not Linear priority). **TOR-141 (E2E playbooks)** is a living doc (In Progress, not Focus stack). **Back-burner / “Deferred this cycle” is paused** (author 2026-06-21) — open work stays in domain sections; sequence via Linear blockers only._

| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-444** (Global XmlUI remount weight — Phase 7 join smoke) | Join Reload UI / multiclient verify after Phase 6 |
| 2 | **TOR-439** (join-stress minimal XmlUI spike verify) | Pairs with TOR-444 Phase 7 |
| 3 | **TOR-436** (blindfold parent off-screen) | Save & Play pending |
...
- [x] **ST roll tray/light before dice + player-like randomize pop:** Tray and light appear together; only then move dice into ring and randomize with the same pop feel as player right-click ROLL. Pending Save & Play. _(TOR-448)_

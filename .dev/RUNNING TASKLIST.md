...
- [ ] **Global HUD missing on first save load:** Object XmlUI OK; Global.xml absent until reload; reload fixes. **Deprioritized** (author 2026-07-16 — trivial reload workaround). relatedTo **TOR-285**, **TOR-381**. Investigate when re-prioritized: `DEBUG.showGlobalHudCanaries()` — no speculative remount. _(TOR-384)_
...
- [x] **Join-stress minimal Global XmlUI spike:** Phases Arm/Disarm Join XML; build-embed full+minimal docs; remount via `U.chain`. Pending author multiclient control/treatment verify. _(TOR-439)_

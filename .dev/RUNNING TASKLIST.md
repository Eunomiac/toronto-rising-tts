...
- [ ] **Global XmlUI remount weight:** ~7435→~2589 Images so far (nestedless+Court+blindfold+location+map districts). Remaining: map sidebars Option B, hunger collapse. Pip branch: `tor-444-court-pip-meters`. See [Global-UI-Image-Stacks](HUDs%20%26%20Overlays/Global-UI-Image-Stacks.md). _(TOR-444)_

...
- [ ] **Global XmlUI remount weight:** ~7435→~1833 Images so far (nestedless+Court+blindfold+location+map districts+sidebars B). Remaining: hunger collapse. Pip branch: `tor-444-court-pip-meters`. See [Global-UI-Image-Stacks](HUDs%20%26%20Overlays/Global-UI-Image-Stacks.md). _(TOR-444)_

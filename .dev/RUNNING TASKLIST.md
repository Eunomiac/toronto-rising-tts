...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-307** — Startup loose-dice cleanup before table sync | Blocks layout sync / TOR-243 guard at load; complements verified preload pool |

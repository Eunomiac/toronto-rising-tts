...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-224** — ST roll panel selective dice reroll | ST dice UX cluster; prerequisite **TOR-218** (dashboard XML templates) Done |
| 2 | **TOR-225** — Display strip canonical dice face sort order | Pairs with TOR-224; broadcast + panel consistency (`blockedBy` **TOR-224**) |
| 3 | **TOR-226** — Secret Storyteller rolls | ST dice UX cluster; follows TOR-224/TOR-225 |

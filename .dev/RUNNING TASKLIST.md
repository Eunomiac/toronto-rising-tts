...
- [x] **Blindfold parent off-screen:** Full-screen `hud_root_panel` + overlay layer/blindfold Panel (`MiddleCenter`, `ignoreLayout`); relatedTo **TOR-431**. Pending Save & Play. _(TOR-436)_

...
- [x] **Group-move onto occupied family auto-evacuates:** Dest occupants jump to first empty priority family (Far L/R/CL/CR ? Mid L/R ? Center L/R ? Mid Center ? palette); board evictions dark-flip. Pending Save & Play. _(TOR-484)_
- [x] **Clear right-click recovers strays to palette:** Right-click Clear parks off-board NPC tokens; left-click Clear unchanged. Pending Save & Play. _(TOR-485)_
...
- [x] **Deselect library preview on close/load/transition; THERE close guard:** Restore green/live editing; block Scenes close while THERE (Black/Host broadcast); load + scene change force HERE; End clears `activeKey`. relatedTo **TOR-417**, **TOR-244**. Pending Save & Play. _(TOR-449)_
...
- [x] **ST toolbar + debug hotkeys replace twirldowns:** One-shot key press toggles (not hold). relatedTo **TOR-238**, **TOR-395**. Pending Save & Play. _(TOR-481)_
...
- [x] **Scene transition lead-in +0.5s; camera in heavy work:** Lead-in 5.0s (XML cards unchanged); TOR-368 default camera moved from beginTransition +1.5s into `runStagedTransition` work step. Pending Save & Play. _(TOR-469)_
...
- [x] **Map sidebar toggles permanently show active chrome:** slot Panels hold layout; empty hover/active → Blue sentinel. relatedTo **TOR-457**, **TOR-444**. Pending Save & Play. _(TOR-462)_

...
- [ ] **Multiplayer E2E playbook:** Pre-invite solo checklist + multiclient session ([Multiplayer-Session.md](E2E%20Playbooks/Multiplayer-Session.md); policy in Preparing For Multiplayer; agent checklist Multiplayer-E2E). Initial pass when friend available — _(TOR-144)_; execution _(TOR-249 — External Todo, human gate)_

...
- [ ] **ST roll tray/light before dice + player-like randomize pop:** Tray and light appear together; only then move dice into ring and randomize with the same pop feel as player right-click ROLL. _(TOR-448)_
...
- [ ] **Deselect library preview on close/load/transition; THERE close guard:** Restore green/live editing; block Scenes close while THERE (Black/Host broadcast); load + scene change force HERE. relatedTo **TOR-417**, **TOR-244**. Unblocked by TOR-417 Done. _(TOR-449)_

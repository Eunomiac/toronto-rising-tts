...
- [ ] **Deselect library preview on close/load/transition; THERE close guard:** Restore green/live editing; block Scenes close while THERE (Black/Host broadcast); load + scene change force HERE. relatedTo **TOR-417**, **TOR-244**; `blockedBy` **TOR-417**. _(TOR-449)_

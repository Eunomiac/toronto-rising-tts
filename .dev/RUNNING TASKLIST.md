...
- [ ] **ST toolbar + debug hotkeys replace twirldowns:** One-shot key press toggles (not hold). relatedTo **TOR-238**, **TOR-395**. _(TOR-481)_
...
- [ ] **Map sidebar toggles permanently show active chrome:** Overlay + district `_active` layers always visible after TOR-457 / Option B. relatedTo **TOR-457**, **TOR-444**. _(TOR-462)_

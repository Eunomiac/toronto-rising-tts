...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-141** — Manual E2E playbooks (Dice + Scenes) | Regression harness before large dice/scene refactors |
| 2 | **TOR-259** — Willpower / Discipline / Humanity / Frenzy roll types | Inbox promotion; blocks TOR-260 roll-type dash wiring |
| 3 | **TOR-224** — ST roll panel selective dice reroll | ST dice UX cluster; pairs with TOR-225 / TOR-226 |

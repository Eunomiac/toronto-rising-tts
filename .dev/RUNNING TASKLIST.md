...
- [ ] **Join-client HUD/UI missing (TTS):** TTS team reviewing save; not a mod scripting failure. _(TOR-381 — External Todo)_
...
| Item | Notes | Linear |
|------|--------|--------|
| Join-client HUD missing | TTS team reviewing save after TOR-144 pass — agents do not invent host-execution gates | TOR-381 _(parent TOR-37)_ |

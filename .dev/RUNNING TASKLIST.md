...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-151** → **TOR-152** — default no-scene env, then restore active scene on Play load | Scene load + control-board sync (incl. PC tokens); **TOR-152** `blockedBy` **TOR-151** |
| 2 | **TOR-237** — Control board Read / Lock / Load toolbar | NPC gameboard Phase B; High priority; stubs today |

...
- [x] **CSHEET right-click tray uses clicked seat:** `GlobalSetSheetCamera` with `modeStem=diceTray` + clicked sheet seat (amends TOR-460). Pending Save & Play. _(TOR-483)_
...
- [x] **Scene transition audio crossfade under blindfold:** New scene audio full before lift; no silence after raise. relatedTo **TOR-469**, **TOR-147**, **TOR-273**. Pending Save & Play. _(TOR-476)_
...
- [x] **Dusk/Dawn stay on same night:** No daytime lerp; midnight may change date. relatedTo **TOR-222**. Pending Save & Play. _(TOR-472)_
- [x] **Years Go under-1000 deltas + right-click rewind:** >=1000 absolute; unsigned <1000 left + / right -; signed negative both ways. relatedTo **TOR-222**. Pending Save & Play. _(TOR-477)_
...
- [x] **Skybox-only Apply brief blindfold:** Fade-in ? apply skybox ? ~2s hold ? lift. relatedTo **TOR-402**. Pending Save & Play. _(TOR-478)_
- [x] **Set present-day refreshes Day/Year/Time green tint:** After Set, clear dirty + refresh present-day green. Pending Save & Play. _(TOR-480)_
...
- [x] **Debug last-load clock still missing under header:** Reserved height + placeholder on `debug_lastLoadClock`. relatedTo **TOR-394**, **TOR-406**. Pending Save & Play. _(TOR-479)_
...
- [x] **Map sidebar toggles permanently show active chrome:** empty audience tint-clears shared `_hover`/`_active` (TTS `None` = team, not hide-all). relatedTo **TOR-457**, **TOR-444**. Pending Save & Play. _(TOR-462)_

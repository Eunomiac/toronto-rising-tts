...
- [ ] **Global XmlUI remount weight:** Image stacks → `setAttribute(image)`; chrome tint; shared panels + visibility unions; `U.setVisibleTo`/`showTo`/`hideFrom`. See [Global-UI-Image-Stacks](HUDs%20%26%20Overlays/Global-UI-Image-Stacks.md). _(TOR-444)_

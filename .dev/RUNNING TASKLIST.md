...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-236** — NPC vs PC control token contract | Phase B prerequisite for **TOR-95** (play-as-NPC / `pc_control_token`) |
| 2 | **TOR-165** — WP reroll wave partial settle | Dice-E2E I1 regression; High priority bug |

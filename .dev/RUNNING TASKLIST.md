...
- [ ] **Global XmlUI remount weight:** ~7435→~1808 Images (Phase 6 core done: nestedless+Court+blindfold+location+map districts+sidebars B+hunger). Optional: location full share; pip meters on `tor-444-court-pip-meters`. Phase 7: Save & Play + join Reload UI smoke. See [Global-UI-Image-Stacks](HUDs%20%26%20Overlays/Global-UI-Image-Stacks.md). _(TOR-444)_

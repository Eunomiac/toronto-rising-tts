...
_Stack rank for the current cycle (2026-08-06: author confirmed TOR-418 / TOR-419 / TOR-459). **Precedence** = Focus stack + Linear **`blockedBy`** (not Linear priority). **TOR-141 (E2E playbooks)** is a living doc (In Progress, not Focus stack). **Back-burner / "Deferred this cycle" is paused** (author 2026-06-21) - open work stays in domain sections; sequence via Linear blockers only._

| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-439** (join-stress re-verify after TOR-444) | Verification gate - remount weight cut needs multiclient re-smoke |
| 2 | **TOR-482** (Daysleep Refresh gold button) | Session-start WP heal UX - only open Focus feature |

**Also in cycle (below top stack):** **TOR-141** (E2E playbooks living doc). **TOR-423** (npc_gameboard split - author confirmed 2026-08-06). **TOR-303** (author review roll broadcast phrasing - External Todo). External: **TOR-88**, **TOR-463**, **TOR-454**, **TOR-456**, **TOR-455**.

...
- [x] **NPC spotlight Y on seat→stage:** Seated NPC moved to lit stage placement — spotlight spawns at feet instead of bounds-aligned Y. _(TOR-234 — defer waits for off-seat ImageScalar; scalar>53 linear +10.99@63 on light Y)_

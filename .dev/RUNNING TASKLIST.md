...
- [x] **Global HUD missing on first save load:** Startup readiness gate canary (`overlay_globalBlindfold`); remount full embedded Global XmlUI via `performFullUiResync` before gate `Sync.full` when missing. relatedTo **TOR-285**, **TOR-381**. _(TOR-384)_

...
- [ ] **Multiplayer E2E playbook:** Pre-invite solo checklist + multiclient test plan (Preparing §1–§2 + Multiplayer-E2E matrix; covers Steam auto-seat **TOR-345**, phase connect/Advance **TOR-143**/**TOR-319**, world I/O). Initial pass when friend available — _(TOR-144)_; execution _(TOR-249 — External Todo, human gate)_

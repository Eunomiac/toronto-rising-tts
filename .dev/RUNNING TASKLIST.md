...
- [x] **End→Intermission cover+theme together:** Leftover session audio fades out and TR_Loop fades in in the same Advance step as the global cover, before table/AdminDark work. relatedTo **TOR-502**, **TOR-497**. Pending Save & Play. _(TOR-506)_

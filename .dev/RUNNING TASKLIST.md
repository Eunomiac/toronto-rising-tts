...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-202** — Duplicate table model on board | Only one CONTROL_BOARD table model for active `currentTableKey` |
| 2 | **TOR-178** — Seat ↔ stage figurine transfer | Gameboard Apply path still needs seated/stage token moves (phase work) |
| 3 | **TOR-174** — NPC token on ST dice bag → roll | Dice E2E gate (TOR-169 stabilizing); resume after gameboard seating fix |

...
_Stack rank for the current cycle (2026-08-22: **TOR-507** numbered-slot layout shipped, pending Save & Play). **Precedence** = Focus stack + Linear **`blockedBy`** (not Linear priority). **TOR-141 (E2E playbooks)** is a living doc (In Progress, not Focus stack). **Back-burner / "Deferred this cycle" is paused** (author 2026-06-21) - open work stays in domain sections; sequence via Linear blockers only._
...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-81** (centralize light modes) | Solo cleanup/unblock work (also gates TOR-320/TOR-321). |
| 2 | **TOR-98** (Spotlight phase remaining UX) | Standalone UX polish in its domain. |
| 3 | **TOR-168** (Sync.full call-site audit) | Low-risk sync hygiene; helps prevent future regressions. |
...
**Done this cycle:** **TOR-516** (Intermission→Play session-start explode — author confirmed 2026-08-27), **TOR-515** (session-start overture opening drum — author confirmed 2026-08-27), **TOR-514** (global blindfold stacked panel — author confirmed 2026-08-27), **TOR-513** (Absent hand/token stash + Apply PC reseat — pending Save & Play), **TOR-247** (control-board token occupancy — pending Save & Play), **TOR-507** (numbered slots + figurine offsets — pending Save & Play), **TOR-505** (frenzy overlay disables Rouse bags — author confirmed 2026-08-22), **TOR-503** (getTracks type() shadow — author confirmed 2026-08-22), **TOR-502** (End→Intermission cover settle — author confirmed 2026-08-22), **TOR-504** (Intermission→Play seat lights — author confirmed 2026-08-22), **TOR-492** (queue roll-result broadcasts — author confirmed 2026-08-22), **TOR-493** (concurrent idle-bag auto-Rouse — author confirmed 2026-08-22), **TOR-498** (outdoor rain particles follow weather — author confirmed 2026-08-22), **TOR-506** (End→Intermission cover+theme together — author confirmed 2026-08-22), **TOR-497** (Intermission→Play Music C overture — author confirmed 2026-08-22), **TOR-501** (Advance overture wait past 60s — author confirmed 2026-08-22), **TOR-500** (hide player roll panel on idle auto-Rouse — author confirmed 2026-08-22), **TOR-499** (Hunger-5 Frenzy auto-open D4, no Cancel — author confirmed 2026-08-22), **TOR-494** (featured tracks fade location ambience — author confirmed 2026-08-22), **TOR-496** (dumpSeatRoleOffsets — author confirmed 2026-08-22), **TOR-491** (idle Oblivion-Rouse bag right-click — author confirmed 2026-08-18), **TOR-487** (Take Half + Rouse auto-confirm — author confirmed 2026-08-18), **TOR-482** (Daysleep Refresh — author confirmed 2026-08-18), **TOR-486** (Clear right-click palette re-snap — author confirmed 2026-08-18), **TOR-489** (Compulsion variant tally — author confirmed 2026-08-18), **TOR-488** (Apply Location full staged blindfold — author confirmed 2026-08-18), **TOR-476** (scene audio card-window crossfade - author confirmed 2026-08-06), **TOR-472** (Dusk/Dawn same night - author confirmed 2026-08-06), **TOR-477** (Years Go deltas / right-click - author confirmed 2026-08-06), **TOR-478** (skybox-only brief blindfold - author confirmed 2026-08-06), **TOR-479** (debug last-load clock height - author confirmed 2026-08-06), **TOR-483** (CSHEET right-click dice tray uses clicked seat - author confirmed 2026-08-06), **TOR-480** (Set present-day green tint - author confirmed 2026-08-06), **TOR-481** (ST/debug hotkeys replace twirldowns - author confirmed 2026-08-06), **TOR-484** (group-move occupied-family eviction - author confirmed 2026-08-06), **TOR-485** (Clear right-click stray recovery - PAVE fail/correct -> TOR-486), **TOR-462** (map sidebar empty audience → Blue sentinel - author confirmed 2026-08-06), **TOR-418** (clock lerp silent no-op - author confirmed 2026-08-06), **TOR-419** (group flip follow-ups - author confirmed 2026-08-06), **TOR-459** (Spotlight→End staged blindfold - author confirmed 2026-08-06), **TOR-473** (bake NPC light modes + family OFFSPOTLIGHT ? author confirmed 2026-08-06), **TOR-470** (clock lerp overlay-only ticks; default every frame ? author confirmed 2026-08-06), **TOR-469** (scene transition lead-in +0.5s; camera snap in heavy work - author confirmed 2026-08-06), **TOR-384** (Global HUD missing on first save load ? startup canary remount), **TOR-460** (CSHEET inner-edge right-click ? diceTray), **TOR-461** (Map/Court/Coteries mutual exclusive), **TOR-100** (Pink Tarot camera diceTray/default ? id reused from canceled Spotlight NPC distinction), **TOR-453** (Scene Time present day when no selection), **TOR-452** (Compulsion + companion with tray), **TOR-448** (ST roll randomize pop ? author confirmed), **TOR-444** (Global XmlUI remount weight ? author confirmed), **TOR-436** (blindfold parent / new animation ? author confirmed), **TOR-450** (location/camera popouts full-alpha), **TOR-451** (sidebar tint grey/white/red), **TOR-449** (Scenes preview deselect + THERE close guard - author confirmed 2026-08-06), **TOR-417** (Control Board HERE/THERE preview editor ? author confirmed 2026-08-03), **TOR-446** (remove FirstPerson on blindfold/scene transition ? author confirmed 2026-08-03), **TOR-447** (Tarot shuffle on activate ? author confirmed 2026-08-03), **TOR-425** / **TOR-431** / **TOR-434** / **TOR-441** / **TOR-445** (blindfold/transition stack ? author confirmed 2026-08-03), **TOR-410** / **TOR-412** / **TOR-416** (stage scale / group move / light lock-on ? author confirmed 2026-08-03), **TOR-428** / **TOR-429** / **TOR-430** / **TOR-432** / **TOR-438** (join-stress controls + timing API ? author confirmed 2026-08-03), **TOR-406**?**TOR-409** / **TOR-411** (debug seat chrome + Tarot Y ? author confirmed 2026-08-03), **TOR-402**?**TOR-405** (INBOX Immediate 2026-07-19 ? still pending Save & Play), **TOR-279** (Stats advantage editor ? author confirmed 2026-07-19), **TOR-222** (animated Scene Time lerp grids ? pending Save & Play; parse/close via TOR-403/405), **TOR-401** (NOW+N travel Apply ? author confirmed 2026-07-19), **TOR-398** (global blindfold ? author confirmed 2026-07-19), **TOR-395** (ST toolbar collapse ? author confirmed 2026-07-19), **TOR-392** (TTS API agent/docs guardrails ? author confirmed 2026-07-19), **TOR-394** (debug last-load HH:MM AM/PM ? INBOX re-open under test), **TOR-396** (debug toolbar +100px Y ? INBOX offset tweak under test), **TOR-397** (Phases sessionNum after End ? author confirmed 2026-07-19), **TOR-390** (API usage inventory ? author confirmed 2026-07-19), **TOR-391** (API hot-path remediation ? author confirmed 2026-07-19), **TOR-381** (join-client HUD ? Phase A re-smoke author confirmed 2026-08-03), **TOR-329** (TTS API heavy-workload catalog ? author confirmed 2026-07-19), **TOR-140** (Sound panel trim ? author confirmed 2026-07-19), **TOR-139** (Scenes library 3-column ? author confirmed 2026-07-19), **TOR-393** (CONTROL_BOARD token Y ? author confirmed 2026-07-19), **TOR-371** (Court page 3 coterie project pool), **TOR-204** (Compulsions deck ? author confirmed 2026-07-19), **TOR-389** (scene Apply syncs occupiedNPCSlots ? author confirmed 2026-07-19), **TOR-385** (Status overlays + Stats/Projects listing), **TOR-386** (domain ratings in PE + Court stake grey), **TOR-387** (Prince's Court stake disabled dots), **TOR-365** (End scene library location ? UI false positive; keep activeKey pending), **TOR-293** (connection?narrative presence), **TOR-328** (POST_ROLL sole-Confirm auto), **TOR-375** (seat reveal + CONTROL_BOARD bake; CSHEET setXml permitted), **TOR-383** (Project Editor start-date space-split parse), **TOR-144** / **TOR-249** (Multiplayer E2E ? real clients passed; residual HUD ? **TOR-381**), **TOR-380** (SIGNAL_FIRE Y preserve on seat layout), **TOR-377** (court tracker flash ? RT clock + coalesce), **TOR-378** (Orange throne PC chair postCorrections), **TOR-379** (map north pin top buffer), **TOR-388** (map pins invisible after taller stack), **TOR-343** (CSHEET preserve page Y on seat layout), **TOR-346** (overlay refresh after deferred soundscape), **TOR-149** (ST tray lights), **TOR-344** (ST drawer absolute homes dummies), **TOR-369** (spotlight shortest-angle), **TOR-366** (Intermission fade-in), **TOR-368** (camera before blindfold raise), **TOR-288** (Red/Brown famulus clicks), **TOR-367** (stage lerp diagnostics),  **TOR-364** (close Phases panel immediately on Advance), **TOR-363** (Intermission?Play blindfold wait: suppress phase auto-hide while advancing), **TOR-362** (Play enter no-scene overlay: detach library mirror + session roman refresh), **TOR-361** (Intermission?Play: 5s Loop fade-out ? 3s Main fade-in ? lift global blindfold), **TOR-360** (Intermission theme = looping TR_Loop @ 0.5 ? skip unreliable Intro?Loop), **TOR-143** (phase redesign Intermission?Play?Spotlight?End + Play subphases; multiclient confirmed via TOR-144), **TOR-319** (Intermission connect/blindfold + dark/theme ? absorbed into TOR-143), **TOR-263** (sessionNum + End exit roman ? folded into TOR-143), **TOR-345** (Steam ID auto seat on connect + load ? ST Black, unregistered White), **TOR-331**?**TOR-335** (INBOX Priority Fixes 2026-07-10 ? Hunger/Blood Surge, ST Cancel hide, NPC seat sync, Table B highest slot, ST dash conditions), **TOR-342** (constants unicode-minus normalize in npm build), **TOR-315** (NPC stage spotlight Y seat?stage ? author verified 2026-07-10), **TOR-325** (Blood Surge Hunger bag on Discipline rolls ? author verified 2026-07-10), **TOR-326** (peer tray lower -4.77y amends **TOR-316** ? author verified 2026-07-10), **TOR-244** (scene library selection preview + edit-before-apply ? author verified 2026-07-10), **TOR-324** (hotseat Red blindfold orphan after mid-transition seat leave; shipped 2026-07-09), **TOR-323** (Clear Loading Overlay ? `active=false` so seat refresh cannot resurrect; shipped 2026-07-09), **TOR-322** (Toggle Lights ambient 0?2 debug button; shipped 2026-07-09), **TOR-307** (startup loose-dice + ST tray restore ? author verified 2026-07-09), **TOR-284** (execution model remediation ? multiclient confirmed via TOR-144), **TOR-308** (preload pool return + adopt-on-load reconcile ? `94e3d25` + `dc7b50e`; author verified 2026-07-08, 264 `d10Preload` cap), **TOR-304** (Apply grow preflight before seat/placement commit; `567dcff`; author verified 2026-07-08), **TOR-311** (scenes panel NPC seat disable ? only toggled seat; author confirmed 2026-07-08), **TOR-287** (dice preload pool ? instant spawn recycle; startup warm), **TOR-296** (roll broadcast message audit doc + debug harness), **TOR-294** (rouse-only roll broadcast ? main die row, author verified 2026-07-05), **TOR-302** (seated NPC ST roll drawer/spawn/light reposition ? anchor-aligned, author verified 2026-07-05; `8c8e7dd` + `d4ce663`), **TOR-281** (stage Clear seat activation rules + live scene-library seat persistence ? step-by-step playbook author verified 2026-07-05; commits `1291042`?`704273b`), **TOR-285** (connect-time / hotseat HUD visibility ? residual join HUD ? **TOR-381**), **INBOX 2026-07-05 quick fixes** (Color Blitz + Jarvis Jacks coterie ref grid; seat-color gate on player dice bags + signal candles; ST roll panel click-hint font; secret ST roll tray reveal on **B** broadcast ? extends **TOR-226**), **TOR-226** (secret Storyteller rolls ? author Save & Play verified 2026-07-03), **TOR-225** (display strip canonical sort + ST tray ellipse spawn ? author Save & Play verified 2026-07-03), **TOR-224** (ST roll panel selective dice reroll ? Done 2026-07-03), **TOR-262** (single live PC roll ? elevate live tray 5y before release; block peer Roll/Take Half until confirm), **TOR-259** (Willpower / Discipline / Humanity / Frenzy roll types ? author verified), **TOR-260** (ST Roll Options modal roll-type selector + pool reset on type change ? author verified; drawer stays open through type/pool resets), **TOR-279** (Storyteller Stats panel ? PC + Coterie advantage editor), **TOR-280** (weather fades in on scene switch, no full-volume snap), **TOR-273** (new-location ambient fade-in starts as blindfold rises, 2s), **TOR-245** (map pins last active location + timestamp ? Save & Play confirmed), **TOR-148** (RT clock acceleration ? wall-time clock + ticker epoch guard), **TOR-274** (library Apply accepts dynamic Table B family key), **TOR-275** (stage control board syncs to seated NPCs on scene change), **TOR-276** (Table A minimap marker 180? rotation), **TOR-277** (palette-parked NPC tokens downscale to default), **TOR-278** (End scene clears seated NPC + Table B0), **TOR-272** (blindfold 1?22 randomization + overlay art changes), **TOR-268** (control-board table-only minimap), **TOR-269** (load soundscape dual-apply), **TOR-270** (weather volume-0 policy), **TOR-151** amend (no-scene Table B0 baseline ? author confirmed 2026-06-26), **TOR-169** (NPC gameboard umbrella ? Phase A/B verified Save & Play; stale workshop gate closed), **TOR-258** (dynamic Table B selection ? author confirmed 2026-06-26), **TOR-267** (FACING Table C layout ? author confirmed 2026-06-26), **TOR-255** (Blood Surge disables Take Half), **TOR-256** (PC seat deactivate syncs hosted conditions), **TOR-257** (figurine tooltips sync with visibility), **TOR-237** (control board Save / Lock / Load toolbar ? Read?state only, Lock toggles `layoutLock`, Load mirrors placements past lock), **TOR-254** (PC keys excluded from NPC placement intent), **TOR-151** (default no-scene environment), **TOR-152** (Play load / Start?Play scene restore + control-board sync path), **TOR-252** (NPC roll broadcast figurine for duplicate fullName ? prefer authoritative `npcCharacterKey` over ambiguous display-name lookup), **TOR-165** (WP reroll wave partial settle ? per-die lock + panel refresh below cap, Confirm-only advance, cap auto-finish; author verified 2026-06-25), **TOR-253** (dice spawn-arc overflow layering), **TOR-236** (npc vs pc control-token contract ? Apply-time PC seat activate/deactivate + NPC-only palette/preload), **TOR-83** (scenes site modal overlap ? flowing VerticalLayout buckets), **TOR-251** (ST normal grid hunger offset labels), **TOR-240** (No Take Half player panel label), **TOR-241** (dice spawn arc RING_STEP 1.5), **TOR-242** (CONTROL_BOARD seat row lower-left). **TOR-162** (ST per-roll Opts modal persist/apply ? author confirmed 2026-06-23) + **TOR-209** (roll panel active conditions display). **TOR-246** (ST POST_ROLL D/H/N pool modification on dashboard). **TOR-243** (block scene/table layout while loose dice on table ? d10 guard). **canApplyManually** registry refactor (`db0f2b4`). **TOR-221** (initial host-authority hardening; execution model corrected by TOR-284; multiclient confirmed via TOR-144). **TOR-233** (PCs panel HP/WP/Hum tracker rows ? `pcs_track_*` 280px min/preferred, panel width 680; `npm run build` OK). **TOR-227** (palette parking snap Z offset ? `parkingSnapLocalZOffset` 0.1 board-local +Z for group labels beneath tokens; `npm run build` OK). **TOR-214** (Oblivion Rouse prompt `Hunger or Stain?`; `oblivChoiceResolved` skips confirm recalculate so broadcast shows chosen outcome). **TOR-220** (Snaps toggle `textColor` on `syncControlBoardSnapsToggleLabel`). **TOR-218** (ST roll dashboard row XML templates ? `ui/.templates/roll/` partials ? build-time `roll_dash_generated.xml`; fixed pixel `offsetXY` layout; `npm run build` OK). **TOR-96** (Tarot hide returns drawn cards ? `returnLooseTarotCardsToDeck()` sweeps `PinkObject`+`TarotDeck` loose cards into deck before off pose; `npm run build` OK; Pink Save & Play to confirm hide). **TOR-179** (unified NPC seat figurine identity ? `SEAT_FIGURE_<seat>` GM Notes on pooled cutout, unified `postCorrectionsBySeatRole`, anchor dual-path removed; author confirmed seat/rotate/unseat + duplicate audit clean 2026-06-15). **TOR-181** (retire Storyteller NPC toolbar panel ? removed `panel_npcs`, generator, dispatch/refresh paths; control board is sole ST NPC UI). **TOR-201** (gameboard frame hitch ? author confirmed perf largely addressed 2026-06-15). **TOR-173** (lerp stage moves on Apply ? anchor-family batching, leader-first stagger, unified timeline, immediate light apply; author confirmed 2026-06-15, commit `81d3710`). **TOR-174** (NPC token on ST dice bag ? roll ? restore home from state + `STR.initiateFromBagLabel`; bag proximity 3?, ST color early gate, local-order fix; author confirmed 2026-06-15). **TOR-178** (seat ? stage figurine transfer ? homeland retained on stage, Clear re-seats, leaves visible + homeland spotlights OFF when stage-bound, pooled spotlight defer/park fixes; author confirmed 2026-06-15). TOR-202 (duplicate CONTROL_BOARD table model ? inactive markers stashed at Y=-200 on table switch; author confirmed 2026-06-15). TOR-210 (Apply seat snap seats NPC at table ? `commitNpcSeatLayout` forces `RSL.SyncTable`; author confirmed 2026-06-15). TOR-154 (C.LockedObjects interactable lock ? nil-hole `DICE_DRAWER_STORYTELLER` + startup-gate apply; author confirmed 70/70). TOR-200 (seat snap Y-rotation ? board-local Y=180? offsets CONTROL_BOARD world Y=180?; author confirmed). TOR-199 (seat-row token scale 0.7 on seat snaps, 0.2 polar; drop-handler scale revert). TOR-198 (Rouse check Roll doubles staged dice ? `spawnMissingPoolDiceForColor`, author confirmed resolved). TOR-197 (event listener O(1) gates + Event Listener Policy). TOR-180 (control-board seat-assignment snap row ? assign/presence/Clear homelands). TOR-172 (palette-drop ring `defaultLightMode` flip + stage light preview). TOR-175 (anchor family spread center-out alternating). TOR-155 (roll panel pool dots color coding). TOR-164 (Dice-E2E harness + doc). TOR-138 (silence-for-save no longer wipes soundscape state; load branch ? TOR-152). TOR-141 baseline shipped (`.dev/E2E Playbooks/`); issue stays **In Progress** as living doc (`living-doc` label). TOR-159 (frenzy at hunger 5 threshold). TOR-158 (Blood Surge + conditions). **TOR-169 session:** circular-require load fix, Z-axis token flip, placements-only reconcile + byArea migration (`a0271ac`). **TOR-170/171:** load token mirror + master-origin figurine yaw (`5c3d37b`). **TOR-176/177:** Host-only control-board XmlUI + hide workshop seat-figure anchors (`b58e2fb`).
...
- [x] **Compulsion card + companion with tray open/close:** On tray open move selected Compulsion to `COMPULSION_CARD_SELECTED_LIVEROLL_<COLOR>` and companion figurine state 1?2 (when enabled); reverse on close. relatedTo **TOR-305**, **TOR-204**. _(TOR-452)_
...
- [x] **Roll baton-pass camera (remaining):** Linear Done 2026-06-27 (tasklist was stale). _(TOR-72)_
...
- [x] **Queue roll-result broadcasts:** When several rolls finish in a row (especially auto Rouse), each fullscreen result stays up for the full six seconds, then a 1s fade gap, then the next. relatedTo **TOR-156**, **TOR-490**. Author confirmed 2026-08-22. _(TOR-492)_
- [x] **Concurrent idle-bag auto-Rouse:** Idle Rouse / Oblivion-Rouse bag right-clicks may overlap when every live player roll is also that shortcut. Ordinary rolls stay one-at-a-time. Same seat cannot start a second auto-Rouse while one is live or cleaning up. relatedTo **TOR-262**, **TOR-490**, **TOR-492**. Author confirmed 2026-08-22. _(TOR-493)_
- [x] **Hide player roll panel on idle auto-Rouse:** Right-click idle Rouse / Oblivion-Rouse does not show `rollControl_root_*`; Cancel is omitted so TOR-328 auto-confirm still fires. relatedTo **TOR-490**, **TOR-491**. Author confirmed 2026-08-22. _(TOR-500)_
- [x] **Hunger-5 failed Rouse auto-opens Frenzy D4, no Cancel:** Queued Frenzy Resist is Storyteller-initiated, Difficulty 4, already Open. relatedTo **TOR-159**, **TOR-203**, **TOR-332**. Author confirmed 2026-08-22. _(TOR-499)_
- [x] **Frenzy overlay disables Rouse bags:** While `hudFrenzy` is on, Rouse and Oblivion-Rouse bags hide; clearing frenzy restores them (Oblivion-Rouse still follows Hunger 5). relatedTo **TOR-203**, **TOR-491**. Author confirmed 2026-08-22. _(TOR-505)_
...
- [x] **ST dice drawers ? absolute X/Z homes per table:** Dummy `x`/`z`/`rotation` on each `C.Tables[*].objectPositions` ST drawer (author tunes later); tray lights hard-lock X/Z to the live drawer (no separate light table entries); restore always uses drawer table absolutes after TOR-302 NPC reposition. _(TOR-344)_
...
- [x] **Startup loose-dice cleanup:** Destroy loose d10 on table + stow trays before startup table sync; preserve d10Preload pool. PC trays: scale-based detect; ST drawers: `STD.reconcileAllToWorkshopHome` always snaps table absolute homes + lights OFF (onLoad + after SyncTable). Author verified 2026-07-09. _(TOR-307)_
...
- [x] **Idle Rouse bag right-click auto-rolls a 1-die Rouse:** No live roll → right-click Rouse bag initiates, Opens, and auto-tosses a standard Rouse check. Live-roll right-click (remove / cancel) unchanged. relatedTo **TOR-317**. Author confirmed 2026-08-18. _(TOR-490)_
- [x] **Idle Oblivion-Rouse bag right-click auto-rolls a 1-die check:** Same shortcut as **TOR-490** on the Oblivion-Rouse bag (Purple). Hunger 5 still locked out. relatedTo **TOR-490**. Author confirmed 2026-08-18. _(TOR-491)_
...
- [x] **CSHEET right-click tray uses clicked seat:** `GlobalSetSheetCamera` with `modeStem=diceTray` + clicked sheet seat (amends TOR-460). Author confirmed 2026-08-06. _(TOR-483)_
- [x] **CSHEET inner-edge right-click ? diceTray:** Left unchanged (`GlobalSetSheetCamera`); right-click ? clicker `diceTray` via `GlobalRollSeatCamera`. _(TOR-460)_
...
- [x] **Split npc_gameboard past Lua 200-local limit:** `core/npc_gameboard.ttslua` exceeded Lua 5.1?s 200 chunk locals; split into board/tokens/snaps/reconcile/apply/interactions/spotlight siblings + thin `Gameboard` facade; add `check:lua-local-limit-gate`. Gate green; author Save & Play smoke confirmed 2026-08-06. _(TOR-423)_
- [x] **Control token tag contract:** Handler matrix + `pcToken:<Color>` identity; Apply-time occupancy from seat-row tokens (TOR-247); reconcile pins PC token to `tableSlot` chair or stashes it at Y=−200 when Absent (TOR-513); NPC-only palette/preload via `D.getNpcCharacters()`. _(TOR-236)_
...
- [x] **Control-board token occupancy:** Chair = numbered seat-row snap; occupant = token identity. Move a PC or NPC token onto a different chair, then Apply, to change table seats. A PC token off the chair row is Absent. Code occupancy changes (PCs-panel Absent, layout) mirror tokens back. Slot number fields removed from PCs and Scenes panels. Geometry is **TOR-507**. Pending Save & Play. _(TOR-247)_
- [x] **Absent hand/token stash + Apply PC reseat:** Absent stashes the hand zone and cards at Y=−200 with the pile, and locks the PC control token at Y=−200. Apply that only moves PC tokens still runs seat layout (occupancy is in the NPC reconcile fingerprint). relatedTo **TOR-247**. Pending Save & Play. _(TOR-513)_
...
- [x] **Absent off restores full seat pile:** Occupancy stash at Y=−200 was keeping satellites (including lights) buried because layout treated that Y as a feature-hide. Snapshot in-session Y on hide; restore `defaultY` for table-height roles. Pink tarot deck stays at the inactive pose (Y −10) unless Consult the Tarot is already on. relatedTo **TOR-507**. Pending Save & Play. _(TOR-512)_
...
- [x] **Stage snap tokenScale:** Ring `tokenScale` / `defaultTokenScale` on drop, scene mirror, pickup, palette. Author confirmed 2026-08-03. _(TOR-410)_
- [x] **CONTROL_BOARD group move (hold hotkey):** `addHotkey("Group move (hold)")`; hold at drop relocates source polar-family cohabitants onto free dest snaps (palette center-out parity). Author confirmed 2026-08-03. _(TOR-412)_
- [x] **Group-move onto occupied family auto-evacuates:** Dest occupants jump to first empty priority family; board evictions dark-flip. Author confirmed 2026-08-06. _(TOR-484)_
- [x] **Clear right-click recovers strays to palette:** Right-click Clear parks off-board NPC tokens; left-click Clear unchanged. Author ❌⚠️ 2026-08-06 → follow-up **TOR-486**. _(TOR-485)_
- [x] **Clear right-click no-op + palette re-snap:** Right-click Clear parks strays, re-snaps on-palette tokens, and always broadcasts ST feedback. Inbox follow-up: one tagged-token scan instead of two. relatedTo **TOR-485**. Author confirmed 2026-08-18. _(TOR-486)_
- [x] **Group relocate close-family stick:** Nearest-catalog occupancy + brief lock/re-assert so Mid Center ? CENTER moves do not leave tokens behind. Author confirmed 2026-08-06. _(TOR-413)_
- [x] **Group flip + palette tokenScale:** Palette?board keeps ring `tokenScale` (no default reset on light apply); hold Group-move while flipping matches family faces to the flipped token. Author confirmed 2026-08-06. _(TOR-414)_
- [x] **Group flip follow-ups:** Capture family+face before Flip settle; re-seat +0.05 Y; no stage light until Apply; siblings match destination face. relatedTo **TOR-414**. Author confirmed 2026-08-06. _(TOR-419)_
...
- [x] **Stage light lock-on + minimal spotlight swing:** Lit stage?stage lerp re-resolves light from live figurine each frame; STANDARD?SPOTLIGHT uses near-STANDARD `deltaUp`/`deltaInward` + spherical arc around aim. relatedTo **TOR-369**, **TOR-173**. Author confirmed 2026-08-03. _(TOR-416)_
- [x] **Bake NPC light modes + family OFFSPOTLIGHT:** Author-tuned STANDARD/SPOTLIGHT baked into D.lights; same-snap-family neighbors dim to OFFSPOTLIGHT while one is SPOTLIGHT (Apply + hold preview). relatedTo **TOR-455**, **TOR-471**. Author confirmed 2026-08-06. _(TOR-473)_
- [x] **Control Board HERE/THERE scene preview editor:** Persistent pending-scene participant draft; mode-aware Reset/Clear/Load; one-shot locked participant merge on scene Apply. relatedTo **TOR-244**, **TOR-237**. Author confirmed 2026-08-03. _(TOR-417)_
- [x] **Deselect library preview on close/load/transition; THERE close guard:** Restore green/live editing; block Scenes close while THERE; End clears `activeKey`. relatedTo **TOR-417**, **TOR-244**. Author confirmed 2026-08-06. _(TOR-449)_
...
- [x] **Rain particle bootstrap miss is quiet:** Load bootstrap may look up `098667` before TTS objects exist; do not print a missing-GUID error for that cold window. relatedTo **TOR-498**. Pending Save & Play. _(TOR-508)_

- [x] **Intermission→Play session-start explode:** Same Play-enter step as the Music C sting starts the stacked cover explode (cover, then still-text / wavering-art pairs, then session number/title). relatedTo **TOR-497**, **TOR-514**, **TOR-515**. Author confirmed 2026-08-27. _(TOR-516)_
- [x] **Session-start overture starts at full volume:** Music C one-shot sets gain to catalog volume before play, so the opening drum is not eaten by the looping silent-arm delay. relatedTo **TOR-497**. Author confirmed 2026-08-27. _(TOR-515)_
- [x] **Intermission→Play session-start overture:** Fade TR_Loop 0.5s, immediately play Music C 71s sting at full volume, lift global blindfold ~2s before the sting ends; move no-scene table prep to Intermission enter. relatedTo **TOR-445**, **TOR-143**. Author confirmed 2026-08-22. _(TOR-497)_
- [x] **Advance overture wait vs 60s chain cap:** Play enter's ~69s cover hold no longer dies at the default `U.chain` 60s timeout; `maxWait` follows sting duration. relatedTo **TOR-497**. Author confirmed 2026-08-22. _(TOR-501)_
- [x] **End→Intermission cover settle:** After showing the global cover, wait ~2s (`U.chain`) before no-scene table prep so FadeIn is not hitch-interrupted. relatedTo **TOR-497**. Author confirmed 2026-08-22. _(TOR-502)_
- [x] **End→Intermission cover+theme together:** Leftover session audio fades out and TR_Loop fades in in the same Advance step as the global cover, before table/AdminDark work. relatedTo **TOR-502**, **TOR-497**. Author confirmed 2026-08-22. _(TOR-506)_
- [x] **getTracks must not shadow Lua `type()`:** Session Starter `effect` copy used `type(effectName)` while the first argument was named `type`, so catalog load failed (`attempt to call a string value`) and character sheets spammed `GlobalResolveSheetPlayerID`. relatedTo **TOR-497**. Author confirmed 2026-08-22. _(TOR-503)_
- [x] **Intermission→Play player seat lights:** OutdoorDim apply now also runs `L.reconcileAllPlayers` so `playerLight*` come back on after AdminDark. relatedTo **TOR-497**. Author confirmed 2026-08-22. _(TOR-504)_

- [x] **Featured tracks fade location ambience:** Sounds-panel featured songs duck `locationA`/`locationB` as well as mood/playlist music; restore on natural end or Stop feat. Ravenwing nightclub bed is location, not Main. Author confirmed 2026-08-22. _(TOR-494)_
...
- [x] **Scenes panel UI trim + 3-column library:** Remove instructional copy; scene buttons show name + status only; three-column grid. Author confirmed 2026-07-19. _(TOR-139)_
...
- [x] **NOW +15/+30/+60/+120 travel-time Apply:** Same as NOW Apply, but advance present-day clock by N minutes during blindfold transition (no lerp). XML ids already in `panel_scenes_library.xml`. Author confirmed 2026-07-19. _(TOR-401)_
- [x] **Animated narrative clock fast-forward:** Scene Time grids (minutes/hours/days/weeks/months + dusk/dawn + year Go); ease-in/out lerp; settle applies clock rules; uses `TorontoSun`. _(TOR-222)_
- [x] **Dusk/Dawn stay on same night:** No daytime lerp; midnight may change date. relatedTo **TOR-222**. Author confirmed 2026-08-06. _(TOR-472)_
- [x] **Years Go under-1000 deltas + right-click rewind:** >=1000 absolute; unsigned <1000 left + / right -; signed negative both ways. relatedTo **TOR-222**. Author confirmed 2026-08-06. _(TOR-477)_
...
- [x] **Apply Location full transition blindfold:** Live District/Site Apply runs the same staged blindfold as scene Apply, including destination district/site cards. Skybox-only stays on **TOR-478**. relatedTo **TOR-425**. Author confirmed 2026-08-18. _(TOR-488)_
...
- [x] **Daysleep Refresh gold button:** Years row far-right gold **Refresh**; session-start WP heal (`Phases.runSessionStartWillpowerHeal`). Works without a live scene; overlay hides after ~6s. relatedTo **TOR-454**, **TOR-143**. Author confirmed 2026-08-18. _(TOR-482)_
...
- [x] **Close ST toolbar before clock lerp:** Same preliminary close as scene Apply. Author confirmed 2026-08-06. _(TOR-405)_
- [x] **Clock lerp silent no-op / present-day advance:** Validate before close; AlertGM on missing live scene / datetime / true zero-delta; forward past present day allowed - `tryAdvance` on settle. relatedTo **TOR-222**, **TOR-405**. Author confirmed 2026-08-06. _(TOR-418)_
- [x] **Scene Time when no scene selected:** Show `presentDayClock` (green) instead of Jan 1 2026 defaults; blank if no present-day set. relatedTo **TOR-449**. _(TOR-453)_
- [x] **Advance: yield after toolbar close:** Defer exit/enter work one frame so close paints without hitch. Author confirmed 2026-08-06. _(TOR-404)_
...
- [x] **End scene ? location wiped from library (reported):** Root cause was panel reading cleared live after End; library row intact (TOR-145 detach OK). **TOR-365** briefly kept `activeKey` on the ended row for panel display; **TOR-449** superseded that ? End now **clears** `activeKey` (deselected). Suite C asserts library siteKey remains and `activeKey` is nil. _(TOR-365)_
...
- [x] **Blindfold default camera ? FirstPerson:** After TOR-368 lookAt snap, `setCameraMode("FirstPerson")` on affected players. **Superseded by TOR-446** (removed). _(TOR-443)_
- [x] **Delete active scene:** Deleting live `lastAppliedKey` row calls `endSceneNarrative` first. _(TOR-146 ? 2026-06-15)_
- [x] **Pre-Apply seat presence modal:** Linear Canceled 2026-07-10 (tasklist was stale). _(TOR-157)_
...
- [x] **Scene change skips location/weather HUD until Scenes panel opens:** Staged Apply/End defer soundscape to fadeIn; `Scenes.applyActiveSceneSoundscapeFromSession` / no-scene soundscape now `Sync.ui({ gameStateOverlay })` after `lastApplied*` mutate. relatedTo **TOR-314**. _(TOR-346)_
...
- [x] **Seated NPCs retain seats when switching to scene without those slots:** Apply scene with fewer/zero NPC seats must vacate figurines + clear `occupiedNPCSlots`; incoming `sessionScene` authoritative via `SceneLibrary.syncOccupiedNpcSlotsFromSeatSlots` before `validateState` (amends **TOR-278** no-scene path). relatedTo **TOR-275**, **TOR-311**. Author confirmed 2026-07-19. _(TOR-389)_
...
- [x] **Global HUD missing on first save load:** Startup readiness gate canary (`overlay_globalBlindfold_panel`); remount full embedded Global XmlUI via `performFullUiResync` before gate `Sync.full` when missing. relatedTo **TOR-285**, **TOR-381**. _(TOR-384)_
...
- [x] **Debug toolbar last-load clock:** `lastLoadClockLabel` on load; label under `== DEBUG ==` (`HH:MM AM/PM`). Author still sees missing ? follow-up **TOR-479**. _(TOR-394)_
- [x] **Debug last-load clock still missing under header:** Reserved height + placeholder on `debug_lastLoadClock`. relatedTo **TOR-394**, **TOR-406**. Author confirmed 2026-08-06. _(TOR-479)_
- [x] **Debug timestamp on panel open:** Re-sync `debug_lastLoadClock` when expanding `adminControlsBody` (inactive setValue ignored). Author confirmed 2026-08-03. _(TOR-406)_
- [x] **Debug toolbar +100px Y:** `storyteller_buttonControls` offsetXY Y 30?130 (twirl-down unchanged). _(TOR-396)_
- [x] **Debug toolbar offset ?20 ?20:** `offsetXY` ?50 130 ? ?70 110. Author confirmed 2026-08-03. _(TOR-407)_
- [x] **Occupied seat-change ? sheet camera:** Left-click debug seat button when client seated ? `sheet<Color>`; empty seat still `changeColor`. Author confirmed 2026-08-03. _(TOR-408)_
- [x] **Signal chrome on seat-change buttons:** Bright green + thick white outline while signal on; left-click clears signal. relatedTo **TOR-408**. Author confirmed 2026-08-03. _(TOR-409)_
...
- [x] **ST toolbar + debug hotkeys replace twirldowns:** One-shot key press toggles (not hold). relatedTo **TOR-238**, **TOR-395**. Author confirmed 2026-08-06. _(TOR-481)_
...
- [x] **Blindfold destination District + Site cards:** On library scene Apply with both keys, set `image` and `UI.show`/`UI.hide` location cards with the transition blindfold; End/table/no-location leave `active=false`. Author confirmed 2026-08-03. _(TOR-425)_
- [x] **Blindfold parent-panel animation:** Animate `playerHud_overlay_blindfold_*` (not per-variant Images); arm children before one `UI.show`; no-location cards stay Clear; hide then ~3s child cleanup. Author confirmed 2026-08-03. _(TOR-431)_
- [x] **Defer transition work until blindfold-down finishes:** `U.chain` waits ~2.5s (slide + card FadeIns) before fade-out / heavy reconcile so animations are not hitch-frozen. Author confirmed 2026-08-03. _(TOR-434)_
- [x] **Scene transition lead-in +0.5s; camera in heavy work:** Lead-in 5.0s; TOR-368 default camera in heavy work. Author confirmed 2026-08-06. _(TOR-469)_
- [x] **leadInDelaySec=0 honored:** `resolveOptSec` (nil-check after tonumber) so explicit 0 skips wait; relatedTo **TOR-434**. _(TOR-435)_
- [x] **Scene transition blindfold double UI.show:** `beginTransition` wrote `hudBlindfold` via `afterChange` (show #1) then `forceReshow` (show #2); now `skipAfterChange` + one armed parent show. TOR-434 lead-in unchanged. Author confirmed 2026-08-03. _(TOR-441)_
- [x] **Blindfold parent off-screen:** Root sibling of global blindfold + matching 1920?1200 MiddleCenter Panel Defaults; new FadeIn/FadeOut animation strategy. Author confirmed 2026-08-03. _(TOR-436)_
- [x] **Location + camera popouts full-alpha:** No idle/hover fade on `popout_locationPanel_*` / `popout_cameraPanel_*`; keep `raycastTarget=true`. _(TOR-450)_
- [x] **Right-sidebar toggle tint:** Idle middling grey, hover white, active deep red (`SIDEBAR_BTN_COLOR_*`). _(TOR-451)_
- [x] **Map / Court / Coteries ? only one open:** Opening Map closes Court/Coteries; opening Court or Coteries closes Map (and sibling). _(TOR-461)_
- [x] **Map sidebar toggles permanently show active chrome:** empty audience → `U.VISIBILITY_EMPTY_SENTINEL` (`Blue`). relatedTo **TOR-457**, **TOR-444**. Author confirmed 2026-08-06. _(TOR-462)_
- [x] **Spotlight→End transition blindfold:** Staged HUDBF transition on Spotlight exit to End (same shape as End scene). relatedTo **TOR-98**, **TOR-143**. Author confirmed 2026-08-06. _(TOR-459)_
- [x] **DEBUG Overlay Alpha toggle:** == DEBUG == button above Print State toggles `overlay_globalBlindfold_panel` Full?Min (panel `raycastTarget` + child Image `color`); label tracks overlay state. _(TOR-442)_
- [x] **Global blindfold stacked panel:** Show/hide/active and HUD canary target `overlay_globalBlindfold_panel` (stacked splash Images inside). Overlay Alpha tints child Images. Author confirmed 2026-08-27. relatedTo **TOR-398**, **TOR-384**, **TOR-442**. _(TOR-514)_
...
- [x] **Center-top overlay polish:** Linear Done 2026-06-04 (tasklist was stale). _(TOR-86)_
- [x] **Weather on overlay:** Linear Done 2026-06-04 (tasklist was stale). _(TOR-87)_
- [x] **PCs panel deactivate PC:** Originally canceled 2026-06-15 (superseded by control-board). **Id reused 2026-08-04** for External recommended client TTS settings ? see Out of Scope table. _(TOR-88)_
...
- [x] **Map panel ? north pins clipped:** Baseline viewport sink in XML; Lua shifts `playerHud_mapViewport_*` down when draggable pan y < 0 (up to +120px at full north). Do not enlarge 1600 draggable. _(TOR-379)_
...
- [x] **Intermission?Play audio crossfade:** Loop out + Main in together over **5s**, then lift global blindfold (supersedes TOR-361 staged 5s+3s). Author confirmed 2026-08-03. _(TOR-445)_
...
- [x] **Manual disabled vs project stake glyphs:** Sheet/Court paint `dot_grey_red_x` (manual) and `dot_project` (stakes) as separate right-edge bands; stake ledger stays derived. _(TOR-427)_
...
- [x] **Solo Host auto Assume Players Connected:** Intermission?Play Advance enables DEBUG assume when exactly one connected player and they are Host. Author confirmed 2026-08-03. _(TOR-429)_
- [x] **Defer setXML + Auto-Seat join controls:** Phases: Defer setXML + Refresh XML (global; persists); PCs rows: Defer Auto-Seat + Auto-Seat (per color; persists). Skips automatic `UI.setXml` / chronicle auto-seat only. Author confirmed 2026-08-03. _(TOR-428)_
- [x] **Defer Connect + Connect:** PCs rows: Defer Connect (O(1) skip of all `onPlayerConnect` for that color) + Connect (force-run). Persists in `connectionControls.deferConnectByColor`. Author confirmed 2026-08-03. _(TOR-430)_
- [x] **connectionControls survive Save:** Whitelist `connectionControls` in `buildSaveState` so Defer setXML / Auto-Seat / Connect toggles do not reset on reload. Author confirmed 2026-08-03. _(TOR-432)_
...
- [x] **Join-load inventory (research):** Engine vs Host Lua connect cost; save 230 ? 1087 CustomUIAssets + 930 ObjectStates; ranked defer candidates. See [Join-Load Inventory](Multiplayer%20Functionality/Join-Load%20Inventory.md). _(TOR-437)_
- [x] **Timing API merge:** `U.stagger` / `U.chain` / `U.await` (+ `U.cancel`); `Time.time` clocks; unique chain waiters; hard-cut old names. Policy + handoff updated. Author confirmed 2026-08-03. _(TOR-438)_
- [x] **Join-stress minimal Global XmlUI spike:** Code + staged restore shipped. Multiclient: **1 Assets / 3 Emitters / 4 Figurines OK**; **2 HUD** timed out ? drove **TOR-444**. Pending re-verify whether reduced Global HUD lets step 2 survive (or makes Arm pipeline unnecessary). _(TOR-439)_
...
- [x] **Pink Tarot deck spawn Y:** `TAROT_DECK_PINK.on.position.y` 12 ? 7.7 (semi-lock physics). Author confirmed 2026-08-03. _(TOR-411)_
...
- [x] **Compulsion variant tally:** On first choice from the four master-deck cards, increment `gameState.playerData[playerID].compulsionsTally[Type][1-4]`. relatedTo **TOR-204**. Author confirmed 2026-08-18. _(TOR-489)_
...
- [x] **Spotlight phase** — Play→Spotlight staged cover: narrative clear, Table A, Spotlight skybox, Main-only audio (no silence-all), in-session carousel + Host strip, ritual overlay. Spotlight→End: Table B0 + Generic skybox, overlay **DEBRIEF**, bags/companions/decks stay parked until Intermission cover. Workshop stand-ins come from `DEBUG.populateSpotlightFigurines()` (paste GUIDs into `lib/guids.ttslua`); Advance does not auto-spawn. Pending Save & Play. _(TOR-98)_
...
- [x] **Dice E2E K3a/K3c promote PRE_ROLL:** Drop `skipOpen` so Normal-bag promote works; K1b cold-start assert SETUP; P-F open before Roll. _(TOR-357)_
- [x] **Dice E2E P-F PRE_ROLL assert before HUMAN Roll:** Explicit `rollConfirm` phase + PRE_ROLL HUMAN cue (hardens TOR-357). _(TOR-358)_
- [x] **Dice E2E Suite P 2-die pool:** `rollE2eAddPoolKindSpawn` to exactly 2 obliv dice (bag?2 after auto-spawn made 3). _(TOR-359)_
- [x] **Multiplayer E2E playbook:** Initial multiclient pass with real clients **Done** (2026-07-13). Docs: [Multiplayer-Session.md](E2E%20Playbooks/Multiplayer-Session.md); Preparing For Multiplayer; Multiplayer-E2E. Residual join HUD ? **TOR-381**. _(TOR-144)_ _(TOR-249)_
- [x] **Join-client HUD/UI missing (TTS):** Ported EmoJuice deferred full-UI resync fallback + seat-layout miss skip; Phase A re-smoke author confirmed 2026-08-03. _(TOR-381)_
...
- [x] **Execution model remediation:** Host-execution gates removed; actor identity + per-client UI retained (`77cac3f`); multiclient confirmed via **TOR-144**. _(TOR-284)_
...
- [x] **TTS API heavy-workload catalog (phase 1):** Review TTS API docs; catalog synchronous heavy-work functions. See [TTS API Heavy-Workload Catalog](Sychronizing%20Game%20Functionality/TTS-API-Heavy-Workload-Catalog.md). Author confirmed 2026-07-19. _(TOR-329)_
- [x] **TTS API heavy-workload usage inventory (phase 2):** Grep every cataloged API call site. Unblocked by **TOR-329**. Author confirmed 2026-07-19. _(TOR-390)_
- [x] **TTS API heavy-workload remediation (phase 3):** Plan + fix hot paths from inventory. `blockedBy` **TOR-390**. Author confirmed 2026-07-19. _(TOR-391)_
- [x] **TTS API heavy-workload agent guardrails (phase 4):** Update docs/rules so agents avoid new hot-path misuse. `blockedBy` **TOR-391**. Author confirmed 2026-07-19. _(TOR-392)_
...
| Willpower-healing session modal style | Visual/copy polish for session-start WP heal popup | TOR-454 |
| Site/District Aspects ? location Conditions | Chronicle review of Aspects for Conditions that should apply | TOR-456 _(relatedTo TOR-85)_ |
| NPC spotlight obviousness | Tune cone/intensity so spotlit figurines read clearly ? baked values + family OFFSPOTLIGHT in **TOR-473** (repo); workshop polish may remain | TOR-455 _(relatedTo TOR-266, TOR-473)_ |
| Recommended client TTS settings | UI scale min + all Visibility OFF (join checklist) | TOR-88 _(repurposed from canceled PCs deactivate)_ |
| Snowfall from The Thing mod | Steal/adapt snowfall VFX for weather/atmosphere | TOR-463 |

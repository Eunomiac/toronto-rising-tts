...
- [ ] **Absent player presence override:** Disconnected chronicle seats inactive; connect restores scene presence + auto-seat + camera then blindfold; disconnect disables present seats; DEBUG toggle skips for dev. Unblocked after **TOR-144**. _(TOR-293)_

...
- [x] **Auto seat/color on connect** from Steam ID (`onPlayerConnect` + `C.PlayerData` chronicle mapping). _(TOR-94 — 2026-06-15)_ — incomplete for multiclient; see **TOR-345**
- [ ] **Auto-assign seat colors by Steam ID on connect (multiclient gate):** Including Storyteller; blocks **TOR-249**. relatedTo **TOR-94**. _(TOR-345)_

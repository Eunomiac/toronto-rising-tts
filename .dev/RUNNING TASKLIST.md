...
- [ ] **Open player dice tray on roll initiate:** Drawer opens when ST opens roll (PRE_ROLL), not on first bag die spawn — visual cue to assemble dice. _(TOR-305)_
- [ ] **Take Half auto-broadcast:** Pure Take Half confirms/broadcasts without extra Confirm; general single-button auto-proceed on roll panel. _(TOR-306)_
...
- [ ] **Control board Apply dice-guard retry:** Aborted Apply (dice on table) must not fingerprint-skip retry after dice cleared. _(TOR-304)_

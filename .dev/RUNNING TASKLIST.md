...
- [ ] **Clear right-click no-op + palette re-snap:** Right-click Clear must move strays and re-snap misplaced palette tokens; no silent zero-move. relatedTo **TOR-485**. _(TOR-486)_

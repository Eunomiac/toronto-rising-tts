...
- [x] **Scene library selection preview + edit-before-apply:** Selecting a library row previews Table/Seats/Location/Time (blue “on” while pending); Table/Seats/Location write to selected row unless it matches live scene (then immediate apply). Clock draft unchanged. _(TOR-244)_

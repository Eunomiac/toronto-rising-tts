...
- [ ] **Automatic table selection:** Resolve `Table B` → `Table B<N>` by occupied NPC seat count; rename bare `Table B` → `Table B5`; error when variant missing. `blockedBy` **TOR-261** (workshop Table B0). _(TOR-258)_

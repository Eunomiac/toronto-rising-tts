...
- [x] **Intermission phase:** Absorbed into TOR-143 — dark lights + theme on enter; connect keeps blindfold up in Intermission; lowers on other phases / Play enter. Countdown timer optional TBD. _(TOR-319)_

...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-308** — Preload pool dice destroyed instead of returned | Regression after **TOR-287** — pool integrity affects every roll |

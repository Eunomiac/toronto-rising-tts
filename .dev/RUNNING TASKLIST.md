...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-144** — Multiplayer E2E playbook | TOR-221 bootstrap guards shipped; ready for multi-client verification |
| 2 | **TOR-83** — Site modal overlap fix | Scenes panel click target bug; quick fix state in Linear |

...
- [x] **Bake NPC light modes + family OFFSPOTLIGHT:** Author-tuned STANDARD/SPOTLIGHT baked into D.lights; same-snap-family neighbors dim to OFFSPOTLIGHT while one is SPOTLIGHT (Apply + hold preview). relatedTo **TOR-455**, **TOR-471**. Pending Save & Play. _(TOR-473)_

...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-178** — Seat ↔ stage figurine transfer | Gameboard Apply path: same figurine table↔stage; retain seat on Clear (phase C remaining) |
| 2 | **TOR-174** — NPC token on ST dice bag → roll | Dice E2E; resume after gameboard seating + table switch fixes |
| 3 | **TOR-173** — Lerp stage moves on Apply | Polish stage figurine motion when placement changes on Apply |

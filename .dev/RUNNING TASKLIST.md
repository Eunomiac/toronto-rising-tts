...
- [ ] **FACING table layout (Phase 2):** `Table C` seating geometry from bbox side segmentation (`side` = angle deg); shape dispatch + camera/marker/fingerprint consumers. `relatedTo` **TOR-258**. _(TOR-267)_

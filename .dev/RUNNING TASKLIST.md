...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-238** — Hover token → stage figurine spotlight preview | NPC gameboard Phase B; after TOR-237 toolbar |
...
- [x] **Control board Read / Lock / Load:** XmlUI toolbar wired — Read→placements state only, Lock toggles `layoutLock`, Load mirrors tokens (bypasses lock). _(TOR-237)_

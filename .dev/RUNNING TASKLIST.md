...
- [x] **Map sidebar toggles permanently show active chrome:** U.setVisibleTo heals missing visibility to explicit None (remount unrestricted). relatedTo **TOR-457**, **TOR-444**. Pending Save & Play. _(TOR-462)_

...
- [x] **Single live PC roll:** One live roll at a time; lower other pre-live trays 4y; ST cannot open second PC roll while live. `lib/pc_roll_tray_lower.ttslua`, `RC.startRolling` / `initiateRoll` / cancel + post-broadcast cleanup. _(TOR-262)_

...
_Stack rank for the current cycle (2026-08-18 afternoon inbox: author confirmed **TOR-487** / **TOR-491** / **TOR-482** / **TOR-486**; Immediate **TOR-492** broadcast queue to Focus #1). **Precedence** = Focus stack + Linear **`blockedBy`** (not Linear priority). **TOR-141 (E2E playbooks)** is a living doc (In Progress, not Focus stack). **Back-burner / "Deferred this cycle" is paused** (author 2026-06-21) - open work stays in domain sections; sequence via Linear blockers only._
...
| # | Issue | Why now |
| --- | --- | --- |
| 1 | **TOR-492** (queue roll-result broadcasts) | Rapid auto-Rouse broadcasts overwrite each other; each should play the full six seconds. |
...
| 4 | **TOR-98** (Spotlight phase remaining UX) | Standalone UX polish in its domain. |
...
- [ ] **Queue roll-result broadcasts:** When several rolls finish in a row (especially auto Rouse), each fullscreen result should stay up for the full six seconds before the next one. relatedTo **TOR-156**, **TOR-490**. _(TOR-492)_

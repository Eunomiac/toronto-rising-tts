...
- [ ] **Scene transition audio crossfade under blindfold:** New scene audio full before lift; no silence after raise. relatedTo **TOR-469**, **TOR-147**, **TOR-273**. _(TOR-476)_
...
- [ ] **Dusk/Dawn stay on same night:** No daytime lerp; midnight may change date. relatedTo **TOR-222**. _(TOR-472)_
- [ ] **Years Go under-1000 deltas + right-click rewind:** >=1000 absolute; unsigned <1000 left + / right -; signed negative both ways. relatedTo **TOR-222**. _(TOR-477)_
...
- [ ] **Skybox-only Apply brief blindfold:** Fade-in → apply skybox → ~2s hold → lift. relatedTo **TOR-402**. _(TOR-478)_
...
- [ ] **Debug last-load clock still missing under header:** Investigate live XmlUI / layout / sync. relatedTo **TOR-394**, **TOR-406**. _(TOR-479)_
...
- [ ] **Spotlight→End transition blindfold:** Advance Spotlight→End should run scene-like blindfold sequence (not only `applyNoSceneDefault`). relatedTo **TOR-98**, **TOR-143**. _(TOR-459)_

...
- [x] **Preload pool return regression:** Used dice must return to pool (12/bag); only overflow spawns destroyed on resolution. Table/tray sweeps use `DPP.releaseOrDestroy`; bag cleanup before tag sweep. _(TOR-308)_

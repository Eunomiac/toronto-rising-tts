...
- [x] **Execution model remediation:** Remove inverted host-execution gating (`isHostClient`, `requireHostForWorldMutation`, join-client bootstrap); keep actor identity + per-client UI; rewrite multiplayer docs/rules. _(TOR-284)_

...
- [x] **Map sidebar toggles permanently show active chrome:** empty audience → `U.VISIBILITY_EMPTY_SENTINEL` (`Blue`). relatedTo **TOR-457**, **TOR-444**. Pending Save & Play. _(TOR-462)_

...
| Player **right-clicks** `DICEBAG_OBLIVROUSE` with no active roll | Shortcut (**TOR-491**): same as idle Rouse right-click, but a 1-die Oblivion Rouse check. Hunger 5 stays locked out (same as left-click). After settle, existing Confirm / Hunger-or-Stain / auto-apply rules still apply. |

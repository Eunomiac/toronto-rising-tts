...
_Last populated: 2026-08-18 afternoon inbox — cleared ✅ **TOR-487** (Take Half + Rouse auto-confirm), **TOR-491** (idle Oblivion-Rouse bag), **TOR-482** (Daysleep Refresh), and **TOR-486** (Clear right-click). **TOR-439** remains a multiclient gate (not a solo Save & Play)._

...
_Last populated: 2026-08-22 late inbox follow-up — author confirmed **TOR-506** (End→Intermission audio with the cover). **TOR-439** remains a multiclient gate (not a solo Save & Play)._

...
| `HUD_memoriamModalSlider` | `memoriam_modal_period_selection_slider` | `(player, value, id)` | ST-gated. Maps 0–2400 onto the constructed timeline (date, location, gold bar including nested chunks, scene highlight). Deselects a scene button that is not in the new period. |

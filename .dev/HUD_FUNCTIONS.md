...
| `HUD_phaseArmJoinXml` | `phase_armJoinXml` | `(player, button, id)` | ST-gated. Sets `joinXmlArmed` + Defer setXML; remounts **minimal** Global XmlUI before a struggling client joins (TOR-439 experiment). |

...
|---|---|---|---|
|cast( ` table ` parameters)|Returns Table containing information on hit Objects.|return ` table `|[#cast](#cast)|
|getGravity()|Returns directional Vector of the direction gravity is pulling.|return ` vector `| |
|setGravity( ` vector ` direction)|Sets the direction gravity pulls.|return ` boolean `| |
...
[../types/](../types/)Returns Table containing information on hit Objects. There are three kinds of casts:
...
>
> * [../types/](../types/) **parameters**: A Table of parameters used to guide the function.
>
> * [../types/#vector](../types/#vector) **parameters.origin**: Position of the starting point.
>
> * Optional, defaults to {x=0, y=0, z=0}.
> * [../types/#vector](../types/#vector) **parameters.direction**: A direction for the cast to move in.
>
> * Optional, but cast is motionless without a direction.
> * [../types/](../types/) **parameters.type**: The type of cast. 1 = Ray, 2 = Sphere, 3= Box
>
> * Optional, defaults to 1.
> * [../types/#vector](../types/#vector) **parameters.size**: Size of the cast shape. Sphere/Box only.
>
> * Optional, defaults to {x=0, y=0, z=0}.
> * [../types/#vector](../types/#vector) **parameters.orientation**: Rotation of the cast shape. Box only.
>
> * Optional, defaults to {x=0, y=0, z=0}.
> * [../types/](../types/) **parameters.max_distance**: How far the cast will travel.
>
> * Optional, defaults to infinity. Won't move without direction.
> * [../types/](../types/) **parameters.debug**: If the cast is visualized for the user.
>
...
> * [../types/](../types/) **table**: A numerically indexed Table, one entry for each hit Object. Entries are in the order of being hit.
>
> * [../types/#vector](../types/#vector) **table.point**: Position the cast impacted the Object.
> * [../types/#vector](../types/#vector) **table.normal**: The surface normal of the impact point.
> * [../types/](../types/) **table.distance**: Distance between cast origin and impact point.
> * [../types/](../types/) **table.hit_object**: An Object reference to the Object hit by the cast.
> * [../types/#vector](../types/#vector) **table.point**: Position the cast impacted the Object.
> * [../types/#vector](../types/#vector) **table.normal**: The surface normal of the impact point.
> * [../types/](../types/) **table.distance**: Distance between cast origin and impact point.
> * [../types/](../types/) **table.hit_object**: An Object reference to the Object hit by the cast.

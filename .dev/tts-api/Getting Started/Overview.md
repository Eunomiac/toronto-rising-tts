...
## Available scripting methods {#available-scripting-methods}

### In-Game Lua Editor {#in-game-lua-editor}
...
### Official Atom Plugin {#official-atom-plugin}
...
### External Editor API {#external-editor-api}

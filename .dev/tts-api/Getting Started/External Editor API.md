...
## Atom as the Server {#atom-as-the-server}
...
### Pushing New Object {#pushing-new-object}
...
### Print/Debug Messages {#printdebug-messages}
...
## Tabletop Simulator as the Server {#tabletop-simulator-as-the-server}
...
### Get Lua Scripts {#get-lua-scripts}
...
TTS listens for a JSON message with an ID of 2 containing a custom message to be forwarded to the [onExternalMessage](../events/#onexternalmessage)event handler in the currently loaded game.

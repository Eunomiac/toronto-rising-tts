...
4. **Site-card gate (~0.5s after fade-out)** — wait until site FadeIn completes (~5.5s wall clock: delay 4.5 + duration 1) so heavy work does not hitch-freeze the card animation.

...
(Standalone table toggles still use `runTransition`, which also waits for blindfold-down before work; the legacy single-burst `runTransitionAfterLeadIn` remains for callers that apply everything at once.)

...
8. `Spotlight.reconcileFromState()` — after seat layout so Spotlight hide-list (bags / seat figurines / companions / compulsion decks) wins over layout restore while `currentPhase == Spotlight` (TOR-98).

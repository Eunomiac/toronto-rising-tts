...
| `HUD_scenesPanel` / apply / lib / ctor / clock / location+skybox modals | B+C | Yes | modal opens Tier A; TOR-142: four Apply button ids → clock modes via `HUD_scenesLibApply`; skybox pick/clear Tier B until Apply location |

...
| `HUD_popoutCameraControl_click` / `HUD_alphaControl_hover*` | A | — | Camera picker: left-click opens + `default`; right-click `M.lookAtNPC` (elevated default focus, horizon yaw toward next occupied stage NPC, keep distance, then FirstPerson) (TOR-538 / TOR-562); Apply resets cycle |

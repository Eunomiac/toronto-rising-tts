...
**From Cursor / VS Code:** Run Task → **Storyteller Dashboard: Dev (server + browser)**. This builds the client and server, starts the Node process in a dedicated terminal (click the printed `http://127.0.0.1:8787` link), and opens Chrome.

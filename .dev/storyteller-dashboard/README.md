...
1. **Stage NPCs** (default) — searchable generic cutout grid, saved search tags, 500px hover preview of the full cutout, selection queue, copy comma-separated keys. Catalogue from **Generics Export** via `npm run generic-npcs:import`. See [Generic NPCs.md](../Storyteller%20Dashboard%20Docs/Generic%20NPCs.md).

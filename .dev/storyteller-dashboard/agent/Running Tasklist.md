...
✔️ SD-PCs. Live-play **PCs** tab: two-page spread matching sheet page 1, player rail replacing the in-game Storyteller PCs toolbar, GSAP ring menus, TTS snapshot/apply over execute-lua. Visual Playwright pass still owed after reboot.

...
✔️ SD-PCs Clear port. Status notice has a **Clear port** button that stops other 39998 holders (including TTS Tools) and retries the live sheet. Leaves Tabletop Simulator and the dashboard process running.

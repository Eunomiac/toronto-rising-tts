...
- **Family-first snaps:** Drop targeting picks the nearest polar *pack*, then the nearest snap inside it. Dashboard polar UVs skip `DEFAULT_STAGE_WORLD` radial stagger so overlay dots follow the painted packs (and in-game clusters).

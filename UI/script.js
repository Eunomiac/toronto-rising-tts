...
var HUD = (() => {
  ...
  function handleAnimationRequest(data) {
    ...
    switch (animationType) {
      case "fadeIn":
        gsapWithCSS.fromTo(target, { opacity: 0 }, { opacity: 1, duration: 0.5 });
        break;
      case "fadeOut":
        gsapWithCSS.to(target, { opacity: 0, duration: 0.5 });
        break;
      case "slideIn":
        gsapWithCSS.fromTo(target, { x: -100, opacity: 0 }, { x: 0, opacity: 1, duration: 0.5 });
        break;
      case "slideOut":
        gsapWithCSS.to(target, { x: 100, opacity: 0, duration: 0.5 });
        break;
      case "bounce":
  ...
  function animatePanelEntrance(panelId) {
    const panel = document.getElementById(panelId);
    if (panel) {
      gsapWithCSS.from(panel, {
        duration: 0.5,
        scale: 0.8,
        opacity: 0,
        rotation: -5,
  ...
  function animatePanelExit(panelId) {
    const panel = document.getElementById(panelId);
    if (panel) {

...
| Starting a fresh agent session | **`/tr-start`** ([`.cursor/skills/tr-start/SKILL.md`](../../.cursor/skills/tr-start/SKILL.md)): Focus + mandatory policy reads + architecture non-negotiables; in Cursor, commit without asking unless the author explicitly says not to; after Linear **In Progress**, prompt author to rename chat (`TOR-XXX — title`) — agents cannot rename Cursor chats |
